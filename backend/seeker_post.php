...
mysql_select_db("iv", $con);
  echo "hello";
 $r=mysql_query("INSERT INTO event(event_id,place,date,time,duration,deadline,ph_no,evnt_des,type_vol) VALUES ('$event_id','$place','$date','$time','$duration','$deadline','$ph_no','$event_des','$type_vol')");
